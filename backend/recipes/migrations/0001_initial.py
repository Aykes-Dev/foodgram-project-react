# Generated by Django 3.2 on 2023-09-22 12:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', through='recipes.Composition', to='recipes.Ingredient', verbose_name='Продукты')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, unique=True, verbose_name='Название')),
                ('color', models.CharField(default='#FF0000', max_length=7, unique=True, validators=[recipes.validators.validate_color], verbose_name='Цвет')),
        ...
        migrations.AddField(
            ...
            name='ingredients',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='compositions', to='recipes.ingredient', verbose_name='Продукты'),
        ),
        migrations.AddField(
            model_name='composition',
            name='recipe',
